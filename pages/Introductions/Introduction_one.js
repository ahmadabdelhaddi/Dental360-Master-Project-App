...
import IntroductionImg1 from "../../assets/Introduction_one.png";
import stepOne from "../../assets/stepOne.png";
import { useNavigation } from "@react-navigation/native";

const Introduction_one = () => {
  const navigation = useNavigation();
  return (
    <View style={styles.container}>
      <View> 
        <Image source={IntroductionImg1} />
      </View>
      <View>
      ...
      <View style={styles.BtnContainer}>
        <TouchableOpacity
          ...
          onPress={() => {
            navigation.navigate("Introduction_two");
          }}
        >
...
export default Introduction_one;
